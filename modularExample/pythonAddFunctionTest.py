        ...
        while (
            ...
            if int(initial_choice) == 1:
                ...
                for number_element in user_input.split(","):
                    var_add = adding(number_element, var_add, user_input)
                ...
                var_multiply = 1
                for number_element in user_input.split(","):
                    var_multiply = multiply(number_element, var_multiply, user_input)
